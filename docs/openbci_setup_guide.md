...
运动想象有两种方式，**只有第一种能产生有效脑电信号**：

| 方式 | 描述 | 效果 |
|------|------|------|
| **体感想象（Kinesthetic）** | 想象手在动的**感觉**——肌肉收缩、关节弯曲、皮肤触感 | 好，能激活运动皮层 |
| 视觉想象（Visual） | 在脑中**看到**一只手在动，像看电影一样 | 差，激活的是视觉皮层 |

### 具体怎么想象

**左手箭头 ←**：
- 想象左手**握拳**的感觉——手指慢慢收紧，指尖压到掌心，感受肌肉紧绷
- 或者想象左手**反复抓握**一个球，感受手掌的触感和手指的弯曲

**右手箭头 →**：
- 同样，想象右手握拳或抓握的**感觉**

关键：**不要真的动手！** 只在脑中想象感觉。手臂放松放在扶手或桌上。

### 练习方法（正式采集前做）

1. **先真的动**：真的握几次左手拳，闭眼感受肌肉和关节的感觉
2. **再停下来想**：手放松不动，闭眼回忆刚才握拳的感觉，尝试"重播"那个体感
3. **切换手**：右手同样操作
4. **睁眼练**：睁眼盯着屏幕，同时想象握拳感觉（正式实验就是这样的）

花 2-3 分钟练习，感觉能稳定想象后再开始正式采集。

### 常见错误

- **想太多**：不要分析"我在不在想"，放松、自然地想象即可
- **太用力**：不需要特别集中精力"使劲想"，轻松地想象感觉就够了
- **动了**：手指微动、手臂紧绷都会产生肌电伪迹（EMG），污染 EEG 信号
- **数数/默念**：不要在心里数"左左左"，这是语言活动不是运动想象
- **走神**：休息阶段可以放空，但箭头出现后要立刻开始想象

### 采集中的注意事项

- 采集时**保持安静**，尽量少眨眼、少动
- 眨眼尽量安排在休息阶段（空白屏幕时）
- 感到疲劳时质量会下降，**宁可停下来休息再录下一轮**
- 第一轮可能不太适应，后面几轮通常会好很多
